...
import assignment.assignment2.Department;
import assignment.assignment2.Group;
...
public class Ex1 {
    ...
    public void ques2(Account acc2) {
        ...
        if (countGroups == 0) {
            ...
            System.out.println("assignment2.Group cua nhan vien nay la java Fresher, C# Fresher");
